...
//    String companyCode;
    ...
    public ModelAndView getGeneratedInvoice(HttpServletRequest request, HttpServletResponse response) throws JSONException {
       ...
       String api_getclient = "getclient";
...
//        
       ...
       JSONArray getClients = new JSONArray(restCall.executeRequest(api_getclient, js));
       ...
       int recordClient= getClients.length();
        mv.addObject("getClients", getClients);
        mv.addObject("getClientLength", recordClient);
