...
//        JSONArray getClients = new JSONArray(restCall.executeGet("getclient"));
        
//        System.out.println("Get list of clients "+ getClients);
...
//        mv.addObject("getClients", getClients);
//        mv.addObject("getClientLength", getClients.length());
       return mv;   
    }
...
//            String companyCode= "00109";
    ...
    @ResponseBody
    public String editUser(HttpServletRequest request, HttpServletResponse response, @RequestParam("companyName") String companyName,  @RequestParam("companyCode") String companyCode, @RequestParam("companyEmail") String companyEmail, @RequestParam("companyPhonenumber") String companyPhonenumber,  @RequestParam("id") String id,
            @RequestParam("companyLocation") String companyLocation) throws JSONException{
       ...
       JSONArray employeeDetails= (JSONArray) request.getSession().getAttribute("EmployeeDetails");
        ...
        System.out.println("The loggedinuserDetails is "+ session);
        System.out.println("The Employee Details is "+ employeeDetails);
