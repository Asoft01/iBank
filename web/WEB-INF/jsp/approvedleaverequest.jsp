        ...
        <div id="" class="col-md-12 effect tablediv" style="padding-top: 30px;">
            ...
            <div class="card mx-3 px-3 py-2 mt-5" style="top: -48px;">
                <div class="card mx-1 warning-color white-text px-2">
                    <div class="d-flex align-items-center"><h5 class="bg">Approved Leave Request</h5>
                          <!--<h1>${companyCode}</h1>-->
                ...
                <div class="mt-3">
                    <table id="" class="table table-hover table-sm tbl_approvedrequest tbl_payroll_download">
