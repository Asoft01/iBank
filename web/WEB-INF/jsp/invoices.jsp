            ...
            <form class="text-center" id="addInvoiceForm" style="color: #757575;" action="#!">
                 <div class="row">
                    <select class="browser-default custom-select select-client mb-2" id="select-client">
                        ...
                        <c:choose>
                            <c:when test="${getClients.length() > 0}">
                                <c:forEach begin="0" end="${getClientLength -1}" var="i">
                                    <option data-email='${getClients.getJSONObject(i).get("clientEmail")}' data-phone='${getClients.getJSONObject(i).get("clientPhonenumber")}' data-addr='${getClients.getJSONObject(i).get("address")}' value="${getClients.getJSONObject(i).get("clientName")}" id="iName">${getClients.getJSONObject(i).getString("clientName")}</option>
                                </c:forEach>
                            </c:when>
                                <c:otherwise>
                    ...
                    <div class="text-white" id="clients_select_error"></div>
                </div>
...
<!--                    <div class="md-form col-6 py-1 my-1">
                        ...
                        <label for="iname" id="iname_L"><i class="far fa-address-card mx-1"></i></label>
                        <div class="text-white" id="iname_error"></div>
                    </div>-->

                    <div class="md-form col-12 py-1 my-1">
                        <input type="text" id="iEmail" class="form-control" disabled>
                ...
                <div class="row">
                    <div class="md-form col-6 py-1 my-1">
                        <input type="text" id="iPhone" class="form-control" disabled>
                        <label for="iphone" id="iphone_L"> <i class="fas fa-phone-alt mx-1"></i></label>
                        <div class="text-white" id="iphone_error"></div>
                    </div>

                   <div class="md-form col-6 py-1 my-1">
                        <input type="text" id="iAddress" class="form-control" disabled>
