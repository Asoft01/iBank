        ...
        <div id="" class="col-md-12 effect tablediv" style="padding-top: 30px;">
            ...
            <div class="card mx-3 px-3 py-2 mt-5" style="top: -48px;">
                <div class="card mx-1 warning-color white-text px-2">
                    <div class="d-flex align-items-center"><h5 class="bg">Promotion</h5>
                ...
                <div class="container">
                    <div class="mt-3">
                        ...
                        <!--<button class="btn bg orange darken-4 btn-sm mr-auto text-white" data-toggle="modal" data-target="#requestLeave" id="submitClient" type="button"> <div id="spinner"></div> Request For Promotion </button>-->

                        <div class="mt-2">
                            <!--<span>Total Record</span>-->
                            <h3 class="font-weight-light" id="cm">
                                Total Promoted Employees : ${recordGetEmployeeLength}
                            </h3>
                        </div>
                        <div class="mt-3">
                            <table id="" class="table table-hover table-sm tbl_humanloan_resources">
                                        ...
                                        <tbody>
                                            <c:choose>
                                                <c:when test="${gettingemployee.length() > 0}">
                                                    <c:forEach var="i" begin="0" end="${gettingemployee.length() - 1}">
                                                        <tr class="add-cursor view-single-merchant tremployeeinfo_${i}" id="">
                                                            <td class="text-center">${i + 1}</td>
                                                            <td class="m_id">${gettingemployee.getJSONObject(i).getString("firstname")}</td>
                                                            <td class="m_id">${gettingemployee.getJSONObject(i).getString("lastname")}</td>
                                                            <td class="m_id">${gettingemployee.getJSONObject(i).getString("email")}</td>
                                                            <td class="m_id">${gettingemployee.getJSONObject(i).getString("accountnumber")}</td>
                                                            <td class="m_id">${gettingemployee.getJSONObject(i).getString("grade")}</td>
                                                            <td class="m_id">${gettingemployee.getJSONObject(i).getString("bank")}</td>
                                                            <td class="m_id">${gettingemployee.getJSONObject(i).getString("location")}</td>
                                                            <td class="m_id">${gettingemployee.getJSONObject(i).getString("designation")}</td>
                                                            <td class="m_id">${gettingemployee.getJSONObject(i).getString("datecreated")}</td>
                                                            <td class="d-none">${gettingemployee.getJSONObject(i).getString("id")}</td>
                                                            <td class="m_id"><a class="btn btn-success btn-sm promote_btn employeeinfo_${i}">Promote</td>
