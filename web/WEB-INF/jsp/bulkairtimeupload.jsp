...
<div>
    ...
    <div class="mt-3"> 
        ...
        <form id="buyBulkAirtimeForm" name="buyBulkAirtimeForm" enctype="multipart/form-data" style="color:" action="#!">
            <div class="card effect" style="width: 35rem;">
                <div class="card-body"> 
                    ...
                    <span class="responseStatus"></span>    
                        ...
                        <div class="mt-3 card">
                            <div class="card-body">
                        <table class="table table-striped table-hover tbl_bulkairtimeupload table-sm">
...
//        });
        ...
        data.append('uploader', uploader); // you can append anyone.
        data.append('companyCode', companycode); // you can append anyone.
        data.append('file', {
          uri: selectedFile.uri,
          type: 'appication/csv', // or photo.type
          name: selectedFile
        });
        fetch(apiUrl, {
          method: 'post',
...
//        }
    ...
    $("#upload_btn").click(function() {
        ...
        const selectedFile = document.getElementById('fileToUpload').files[0];
        console.log("uploader "+ uploader + "companycode" + companycode +"file"+selectedFile + "filename" + selectedFile.name);
//        let formData = new FormData();
////        if(file !== null) {
////            formData.append('file', file);
////        }
...
//    });
              ...
              fileData.append('uploader', uploader);
              fileData.append('companyCode', companycode);
              fileData.append('file', {
                uri: selectedFile.uri,
                type: 'application/csv', // or photo.type
                name: selectedFile.name
              });
              console.log("this is fileData "+ fileData);
              fetch('http://68.169.57.98:80/InternetBankingApp/bulkairtimeupload', {
                method: 'POST',
                body: fileData,
                headers: {
    ...
    $('.tbl_bulkairtimeupload').DataTable({
        "ordering": false,
