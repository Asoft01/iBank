...
<div class="container">
    <div class="row">
        ...
        <!--                                    <a id="edit_" class="btn btn-primary btn-sm edit_${i}"><i class="fas fa-edit"></i></a>-->
                                            ...
                                            <td> <a class="btn btn-sm btn-amber viewinvoiceperclient"><i class="fas fa-arrow-alt-circle-right">&nbsp;&nbsp; Invoice</i></a></td>
                    ...
                    <form class="text-center" id="addClientForm" style="color: #757575;" action="#!">
                        <div class="row">
                            <div class="md-form col-6 py-1 my-1">
                                ...
                                <label for="fname" id="fname_L"><i class="far fa-address-card mx-1"></i>Client Name</label>
                                <div class="text-white" id="cname_error"></div>
                            </div>

                            <div class="md-form col-6 py-1 my-1">
                                <input type="text" id="cEmail" class="form-control">
                                <label for="surname" id="surname_L"><i class="far fa-envelope mx-1"></i>Email</label>
                        ...
                        <div class="row">
                            <div class="md-form col-6 py-1 my-1">
                                ...
                                <label for="caddress" id="fname_L"><i class="fas fa-address-card mx-1"></i>Address</label>
                                <div class="text-white" id="caddress_error"></div>
                            </div>

                            <div class="md-form col-6 py-1 my-1">
                                <input type="text" id="cPhone" class="form-control">
                                <label for="phone" id="surname_L"><i class="fas fa-phone-alt mx-1"></i>Phone Number</label>
                    ...
                    <form class="text-center" id="editClientForm" style="color: #757575;" action="#!">
                        <div class="row">
                            <div class="md-form col-6  py-1 my-1" >
                                ...
                                <input type="text" id="cCode" value="${companyCode}">
                                <label for="fname" id="leditName"><i class="far fa-address-card mx-1"></i> Client Name</label>
                                <div class="text-white" id="cname_error"></div>
                            </div>

                            <div class="md-form col-6  py-1 my-1">
                                <input type="text" id="ceditEmail" class="form-control">
                                <label for="surname" id="leditEmail"><i class="far fa-envelope mx-1"></i> Client Email</label>
                                <div class="text-white" id="cemail_error"></div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="md-form col-6 py-1 my-1">
                                ...
                                <label for="caddress" id="leditAddress"><i class="fas fa-address-card mx-1"></i> Client Address </label>
                                <div class="text-white" id="caddress_error"></div>
                            </div>

                            <div class="md-form col-6 py-1 my-1">
                                <input type="text" id="ceditPhone" class="form-control">
                                <label for="phone" id="leditPhone"><i class="fas fa-phone-alt mx-1"></i> Phone Number </label>
                                <div class="text-white" id="cphone_error"></div>
                            </div>
      ...
      <div class="modal-body">
        ...
        <div class="container">
            <form class="text-center" id="addInvoiceForm" style="color: #757575;" action="#!">
                ...
                <div class='row'>
                    <select class="browser-default custom-select select-client mb-2" id="select-client">
                        <option value="" disabled selected>Select Clients</option>
                        <c:choose>
                            <c:when test="${client.length() > 0}">
                                <c:forEach begin="0" end="${totalClient -1}" var="i">
                                    <option data-email='${client.getJSONObject(i).get("clientEmail")}' data-phone='${client.getJSONObject(i).get("clientPhonenumber")}' data-addr='${client.getJSONObject(i).get("address")}' value="${client.getJSONObject(i).get("clientName")}" id="iName">${client.getJSONObject(i).getString("clientName")}</option>
                                </c:forEach>
                            </c:when>
...
<!--                    <div class="md-form col-6 py-1 my-1">
                    ...
                    <div class="md-form col-12 py-1 my-1">
                        <input type="hidden" id="icCode" class="form-control" value="${companyCode}">
                        <input type="text" id="iEmail" class="form-control" readonly>
                        <label for="isurname" id="iemail_L"><i class="far fa-envelope mx-1"></i></label>
                        <div class="text-white" id="iemail_error"></div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="md-form col-6 py-1 my-1">
                        <input type="text" id="iPhone" class="form-control"readonly>
                        <label for="iphone" id="iphone_L"><i class="fas fa-phone-alt mx-1"></i></label>
                        <div class="text-white" id="iphone_error"></div>
                    </div>

                   <div class="md-form col-6 py-1 my-1">
                        <input type="text" id="iAddress" class="form-control" readonly>
                        <label for="iaddress" id="iaddress_L"><i class="fas fa-address-card mx-1"></i></label>
                        <div class="text-white" id="iaddress_error"></div>
                    </div>
                </div>
...
<script>
    $("#select-client").change(function(){
       let option = $("#select-client option:selected");
...
//                   $("#editUser").show();
    ...
    $("#edit_client").click(function (e) {
        ...
        console.log(companyCode + companyName + companyEmail + companyPhonenumber + companyLocation);
//             alert("Here");
        let credentials = {
            "companyCode": companyCode,
            "companyName": companyName,
