...
<!--                       <button class="" style="color: #F05E23; background-color: white;" id="menu-toggle"><i class="fas fa-bars"></i></button>-->
                    ...
                    <div class="list-group list-group-flush sidebar">
                        <p class="ml-2 mb-0 pb-0" style="color: white; font-size: 15px">Welcome ${firstname}</p>
                        <p class="text-white ml-3" style="font-size: 12px">(${companyName})</p>
                        <a data-toggle="collapse" href="#collapseMyaccount" aria-expanded="false" aria-controls="collapseMyaccount" href="" data-href="" class="active"><i class="far fa-user iclass"></i>&nbsp;My Account</a>
                        <div class="collapse" id="collapseMyaccount">
                            <div class="">
                                <a href="${pageContext.request.contextPath}/dashboard" data-href="">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Dashboard</a>
                                <a href="accountstatement" data-href="accountstatement" class="side-link">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Account Statement</a>
                                <a href="profile" data-href="profile" class="side-link">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Profile</a>
                            </div>
                        </div>
                        ...
                        <div class="collapse" id="collapseExample">
                            <div class="">
                                <a data-toggle="collapse" href="#collapseFundTransfer" aria-expanded="false" aria-controls="collapseFundTransfer">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fund Transfer</a>
                                    <div class="collapse" id="collapseFundTransfer">
                                        <div class="">
                                            <a href="fundtransfer" data-href="fundtransfer" class="side-link">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Single Transfer</a>
                                            <a href="bulkfundtransfers" data-href="bulkfundtransfers" class="side-link">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Bulk Transfer</a>
                                        </div>
                                    </div>
                                <a href="scheduletransfer" data-href="scheduletransfer" class="side-link">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Schedule Transfer</a>
                            </div>
                        </div>
                        <a data-toggle="collapse" href="#collapseAirtime" aria-expanded="false" aria-controls="collapseAirtime"><i class="far fa-credit-card iclass"></i>&nbsp;Airtime</a>
                        <div class="collapse" id="collapseAirtime">
                            <div class="">
                                <a href="airtimeanddata" data-href="airtimeanddata" class="side-link">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Single Airtime</a>
                                <a href="bulkairtime" data-href="bulkairtime" class="side-link">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Bulk Airtime</a>
                            </div>
                        </div>
                        <a href="billspayments" data-href="billspayments" class="side-link"><i class="fas fa-user iclass"></i>&nbsp;Bills Payment</a>
                        <a href="collections" data-href="collections" class="side-link"><i class="fas fa-book-open iclass"></i>&nbsp;Collections</a>
<!--                        <br><br><br>
...
<!--                        <a href="payroll" data-href="payroll" class="side-link"><i class="fas fa-lock iclass"></i>&nbsp;Payroll</a> -->
                        ...
                        <a href="invoices" data-href="invoices" class="side-link"><i class="fas fa-lock iclass"></i>&nbsp;Invoice</a>
                        <a class="dropdown-btn"><i class="fas fa-lock iclass"></i>&nbsp;HR</a>
                        <div class="dropdown-container">
                                <a href="employee" data-href="employee" class="side-link">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Employees</a>
                                <a href="grade" data-href="grade" class="side-link">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Grades</a>
                                <a href="designation" data-href="designation" class="side-link">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Designations</a>
                                <a href="department" data-href="department" class="side-link">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Departments</a>
                                <a href="division" data-href="division" class="side-link">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Divisions</a>
                                <a href="location" data-href="location" class="side-link">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Locations</a>
                                <a href="region" data-href="region" class="side-link">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Regions</a>
                                <a href="deduction" data-href="deduction" class="side-link">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Deductions</a>
                                <a href="loan" data-href="loan" class="side-link">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Loans</a>
                                <!--<a href="leave" data-href="leave" class="side-link">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Leave</a>-->
                                <a data-toggle="collapse" href="#collapseLeave" aria-expanded="false" aria-controls="collapseLeave"><i class="fas fa-arrow-circle-right"></i>&nbsp;Leave</a>
                                <div class="collapse" id="collapseLeave"> 
                                    <div class="">
                                        <a href="request" data-href="request" class="side-link">&nbsp;&nbsp;&nbsp;&nbsp;Request</a>
                                        <a href="leavetype" data-href="leavetype" class="side-link">&nbsp;&nbsp;&nbsp;&nbsp;Type</a>
                                        <a href="leavestatus" data-href="leavestatus" class="side-link">&nbsp;&nbsp;&nbsp;&nbsp;Status</a>
                                        <a href="getapprovedrequest" data-href="getapprovedrequest" class="side-link">&nbsp;&nbsp;&nbsp;&nbsp;Approved</a>
                                        
                                    </div>
                                </div>
                                
                                <a data-toggle="collapse" href="#collapseLoan" aria-expanded="false" aria-controls="collapseLoan"><i class="fas fa-arrow-circle-right"></i>&nbsp;Loan</a>
                                <div class="collapse" id="collapseLoan"> 
                                    <div class="">
                                        <a href="loanrequest" data-href="loanrequest" class="side-link">&nbsp;&nbsp;&nbsp;&nbsp;Request</a>
                                        <a href="getapprovedloanrequest" data-href="getapprovedloanrequest" class="side-link">&nbsp;&nbsp;&nbsp;&nbsp;Approved</a>
                                        <a href="disburseloan" data-href="disburseloan" class="side-link">&nbsp;&nbsp;&nbsp;&nbsp;Disburse</a>
                                        
                                    </div>
                                </div>
                                <a href="promote" data-href="promote" class="side-link">&nbsp;&nbsp;&nbsp;Promotions</a>
                           </div>  
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
			...
			<form class="text-center" id="createUserForm" style="color: #757575;" action="#!">
                            ...
                            <input type="hidden" id="firstname" class="form-control" value="${session.getString("firstname")}">
                            <input type="hidden" id="lastname" class="form-control" value="${session.getString("lastname")}">
                            <input type="hidden" id="creator" class="form-control" value="${session.getString("username")}">
                        </form>
                    </div>
		</div>
