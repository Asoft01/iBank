...
<div class="container">
    ...
    <div class="card mx-3 px-3 py-2 mt-5" style="top: -48px;">
        <div class="card mx-1 warning-color white-text px-2">
            <div class="d-flex align-items-center"><h5 class="bg">Leave</h5>
...
//       alert(current_id);
    ...
    $("div.pime-grid-filter").html('<div class="d-flex mr-4"><button class="btn bg orange darken-4 btn-sm mr-auto text-white" data-toggle="modal" data-target="#requestLeave" id="submitClient" type="button"> <div id="spinner"></div> Request Leave</button><p class="ml-3 mr-1">Total Records:'+"${totalLeaveRequest}"+'</p> </div>');
